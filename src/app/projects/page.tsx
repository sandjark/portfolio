            ...
            <button
              ...
              className={`px-4 py-2 text-sm rounded-full border transition-all duration-300 ${
                activeCategory === category
                  ? "bg-[#4975ef] border-[#4975ef] text-white"
                  : "border-[#222] text-[#a0a0a0] hover:border-[#4975ef]/50 hover:text-white"
              }`}
            >
              {category}
            </button>
            ...
            >
              <Link href={`/projects/${project.slug}`} className="group block">
                ...
                <div className="flex items-start justify-between gap-4">
                  <div>
                    <h2 className="text-xl font-medium group-hover:text-[#4975ef] transition-colors">
                      {project.title}
                    </h2>
                  ...
                  <span className="text-sm text-[#4975ef] whitespace-nowrap mt-1">
                    {project.year}
                  </span>
                </div>
              </Link>
